...
INSERT INTO books (book_id, book_name, book_author, book_genre, no_of_copies) VALUES
  (10, 'L1', 'Auteur L1', 'Genre L1', 1),
  (11, 'L2', 'Auteur L2', 'Genre L2', 0),
  (12, 'L3', 'Auteur L3', 'Genre L3', 0),
  (13, 'L4', 'Auteur L4', 'Genre L4', 0),
  (14, 'L5', 'Auteur L5', 'Genre L5', 0)
...
INSERT INTO users (user_id, username, name, password) VALUES
  (10, 'A1', 'A1',  '$2b$10$RN5ij7XXjDpRBALhITW.2uzYGontX4U9c9ZRH5i3e.5l6RvkjZ696'),
  (11, 'A2', 'A2',    '$2b$10$RN5ij7XXjDpRBALhITW.2uzYGontX4U9c9ZRH5i3e.5l6RvkjZ696'),
  (12, 'A3', 'A3',    '$2b$10$RN5ij7XXjDpRBALhITW.2uzYGontX4U9c9ZRH5i3e.5l6RvkjZ696')
ON CONFLICT (user_id) DO NOTHING;
...
--    RG-01 respecté : L2 (11) et L3 (12) sont bien empruntées par A3
--    (return_date null), donc réservables.
--    IDs volontairement distincts (101, 102, 103) pour limiter les collisions
...
INSERT INTO reservations (id, livre_id, adherent_id, date_reservation, date_expiration, statut) VALUES
  ...
  (103, 14, 12, NOW(), NOW() + INTERVAL '7 days', 'EN_ATTENTE')
ON CONFLICT (id) DO UPDATE SET
  livre_id = EXCLUDED.livre_id,
